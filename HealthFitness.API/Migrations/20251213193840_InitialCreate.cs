        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaloriesBurned = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCaloriesBurned = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    TotalCaloriesConsumed = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    TotalActivities = table.Column<int>(type: "int", nullable: false),
                    TotalWorkoutMinutes = table.Column<int>(type: "int", nullable: false),
                    AverageWaterIntake = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    AverageSleepHours = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnalyticsReports_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DataImports_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialValue = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Carbs = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoalReminders = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    EnableAIRecommendations = table.Column<bool>(type: "bit", nullable: false),
                    AutoProgressUpdate = table.Column<bool>(type: "bit", nullable: false),
                    TwoFactorEnabled = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyGoalInMl = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_UserId_Action",
                table: "ActivityLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnalyticsReports_UserId_StartDate_EndDate",
                table: "AnalyticsReports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataImports_UserId",
                table: "DataImports",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_DataImports_UserId_ImportedAt",
                table: "DataImports",
